...
export interface ThemeInfo {
  ...
  icon: 'Worm' | 'Skull' | 'Brain' | 'Pill' | 'Cpu' | 'Dna' | 'Axe' | 'Ghost' | 'Cross' | 'Knife' | 'Footprints' | 'CloudRain' | 'Castle' | 'Radiation' | 'UserMinus2' | 'Anchor' | 'AlertTriangle' | 'Building' | 'Clock' | 'Moon' | 'BookDead';
  description: string;
}