...
import { Clock, Share2, ChevronLeft, ChevronRight, Minus, Plus } from "lucide-react";
...
export default function Reader({ slug }: ReaderPageProps) {
  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      {/* Reader controls toolbar - fixed at top */}
      <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
        {/* Font size controls */}
        <div className="flex items-center gap-1 bg-background/80 backdrop-blur-md border border-border/50 rounded-lg p-1">
          <Button 
            variant="ghost" 
            size="icon" 
        ...
        <ThemeToggle 
          variant="icon" 
          className="h-10 w-10 rounded-full bg-background/80 backdrop-blur-md border border-border/50" 
        />
