 ...
 * @returns A formatted string with reading time
 */
...
/**
 * Counts the number of occurrences of a pattern in text
 * @param text The text to search in
 * @param pattern The pattern to search for
 * @returns Number of occurrences
 */
export function countOccurrences(text: string, pattern: string | RegExp): number {
  if (typeof pattern === 'string') {
    // Split and count the occurrences
