    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed bottom-12 sm:bottom-16 left-1/2 transform -translate-x-1/2 z-50 pointer-events-none"
        >
          <motion.div 
            className="bg-background/90 border border-primary/20 backdrop-blur-md shadow-md rounded-lg px-4 py-3 flex flex-col items-center gap-1 text-center"
            animate={{ y: [0, -5, 0] }}
            transition={{ 
