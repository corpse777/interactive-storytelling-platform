    ...
    <>
      ...
      >
        <Button
          ...
          className="relative px-10 py-6 bg-button hover:bg-hover text-button-text rounded-full shadow-lg hover:shadow-2xl transition-all duration-300"
          size="lg"
        >
          <motion.div
            ...
            className="absolute inset-0 bg-highlight/15 rounded-full"
          />
        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              {/* Cute Message */}
              <h2 className="text-xl font-semibold text-text mb-3">Would you like to support me? ☕💖</h2>
