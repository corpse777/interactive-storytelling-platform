...
export function LikeDislike({ likes = 0, dislikes = 0, onLike, onDislike, className }: LikeDislikeProps) {
  return (
    <div className={cn("like-dislike-container", className)}>
      <div className="text-content">What did you think<br/>of this post?</div>
      <div className="icons-box">
        <div className="icons">
          <label className="btn-label" htmlFor="like-checkbox">
            <span className="like-text-content">{likes}</span>
            <input className="input-box" id="like-checkbox" type="checkbox" onChange={onLike} />
        ...
        <div className="icons">
          <label className="btn-label" htmlFor="dislike-checkbox">
            <input className="input-box" id="dislike-checkbox" type="checkbox" onChange={onDislike} />
            <div className="fireworks">
