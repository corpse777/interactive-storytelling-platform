  ...
  return (
    ...
    >
      <SidebarContent>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-sidebar-accent scrollbar-track-transparent">
          <div className="p-2 sm:p-3 md:p-4 lg:p-5 xl:p-6 min-h-0">
