        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center justify-center gap-8">
            <div className="text-center">
              <h2 className="font-serif text-3xl md:text-4xl text-primary mb-3 tracking-wider">Veritas Vincit Omnia</h2>
              <p className="text-sm text-muted-foreground/90 italic font-serif tracking-wide">Truth Conquers All</p>
            </div>

            <div className="w-full max-w-2xl mx-auto border-t border-primary/10 pt-8">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <p className="text-sm text-muted-foreground/80 font-serif tracking-wide">
