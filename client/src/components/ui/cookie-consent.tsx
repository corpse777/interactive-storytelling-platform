      ...
      <div className="max-w-[300px] w-full mx-auto bg-card rounded-lg shadow-xl border border-border/50 p-6 space-y-4">
        <div className="flex justify-center relative">
          ...
          >
            ...
            />
            <circle cx="30" cy="40" r="8" className="fill-[#3D1C02]" />
            <circle cx="80" cy="35" r="6" className="fill-[#3D1C02]" />
            <circle cx="55" cy="75" r="7" className="fill-[#3D1C02]" />
            <circle cx="40" cy="60" r="5" className="fill-[#3D1C02]" />
            <circle cx="85" cy="65" r="4" className="fill-[#3D1C02]" />
          </svg>
