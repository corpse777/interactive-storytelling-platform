...
export function CookieConsent() {
  ...
  return (
    <motion.div 
      ...
      className="fixed inset-0 grid place-items-center z-50 bg-background/20 backdrop-blur-sm"
    >
      <div className="w-[300px] bg-card/90 backdrop-blur-sm rounded-lg shadow-xl border border-border/50 p-6 space-y-4">
