...
export function CookieConsent() {
  ...
  return (
    <>
      ...
      <Dialog open={isPreferencesModalOpen} onOpenChange={closePreferencesModal}>
        <DialogContent className="sm:max-w-[500px] bg-gradient-to-b from-[#F5F5DC] to-[#E8D9B5] border-2 border-[#C4A484] p-6">
          ...
          <div className="py-4 space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-[#F5F5DC]/50 transition-colors border border-transparent hover:border-[#D2A76C]/30">
              <div className="space-y-0.5">
                <Label className="text-base font-semibold text-[#6F4E37]">Secret Sauce (Marketing)</Label>
                <p className="text-sm text-[#8B5A2B]">Our special recipe that makes these cookies extra special</p>
              </div>
              <Switch 
          ...
          <DialogFooter className="flex flex-col-reverse sm:flex-row gap-3 mt-3">
            <Button
              variant="outline"
