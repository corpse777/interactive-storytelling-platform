              ...
              <Collapsible>
                <CollapsibleTrigger asChild>
                  ...
                  >
                    ...
                    <ChevronDown className="h-4 w-4 shrink-0 text-[hsl(var(--sidebar-foreground))] opacity-50 transition-transform duration-200" />
                  </SidebarMenuButton>
                </CollapsibleTrigger>
                <CollapsibleContent className="space-y-1 px-2 py-1">
                  <SidebarMenuSub>
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/chart-dashboard'}
                        onClick={() => handleNavigation('/chart-dashboard')}
                        className="text-[hsl(var(--sidebar-foreground))] data-[active=true]:bg-[hsl(var(--sidebar-accent))] data-[active=true]:text-[hsl(var(--sidebar-accent-foreground))] hover:bg-[hsl(var(--sidebar-accent))] hover:text-[hsl(var(--sidebar-accent-foreground))]"
                      >
                        <BarChart className="h-3.5 w-3.5 mr-2 opacity-70" />
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/content-test'}
                        onClick={() => handleNavigation('/content-test')}
                        className="text-[hsl(var(--sidebar-foreground))] data-[active=true]:bg-[hsl(var(--sidebar-accent))] data-[active=true]:text-[hsl(var(--sidebar-accent-foreground))] hover:bg-[hsl(var(--sidebar-accent))] hover:text-[hsl(var(--sidebar-accent-foreground))]"
                      >
                        <FileText className="h-3.5 w-3.5 mr-2 opacity-70" />
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/cookie-test'}
                        onClick={() => handleNavigation('/cookie-test')}
                        className="text-[hsl(var(--sidebar-foreground))] data-[active=true]:bg-[hsl(var(--sidebar-accent))] data-[active=true]:text-[hsl(var(--sidebar-accent-foreground))] hover:bg-[hsl(var(--sidebar-accent))] hover:text-[hsl(var(--sidebar-accent-foreground))]"
                      >
                        <FileText className="h-3.5 w-3.5 mr-2 opacity-70" />
                        <span>Cookie Test</span>
                      </SidebarMenuSubButton>
                    </SidebarMenuSubItem>
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/toast-test'}
                        onClick={() => handleNavigation('/toast-test')}
                        className="text-[hsl(var(--sidebar-foreground))] data-[active=true]:bg-[hsl(var(--sidebar-accent))] data-[active=true]:text-[hsl(var(--sidebar-accent-foreground))] hover:bg-[hsl(var(--sidebar-accent))] hover:text-[hsl(var(--sidebar-accent-foreground))]"
                      >
                        <FileText className="h-3.5 w-3.5 mr-2 opacity-70" />
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/demo/toast-demo'}
                        onClick={() => handleNavigation('/demo/toast-demo')}
                        className="text-[hsl(var(--sidebar-foreground))] data-[active=true]:bg-[hsl(var(--sidebar-accent))] data-[active=true]:text-[hsl(var(--sidebar-accent-foreground))] hover:bg-[hsl(var(--sidebar-accent))] hover:text-[hsl(var(--sidebar-accent-foreground))]"
                      >
                        <FileText className="h-3.5 w-3.5 mr-2 opacity-70" />
