              ...
              <Collapsible open={demoOpen} onOpenChange={setDemoOpen}>
                ...
                <CollapsibleContent className="space-y-1 px-2 py-1">
                  <SidebarMenuSub>
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/library-demo'}
                        onClick={() => handleNavigation('/library-demo')}
                        className={submenuItemClass}
                      >
                        <Book className="h-3.5 w-3.5 mr-2 opacity-70" />
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/libraries-demo'}
                        onClick={() => handleNavigation('/libraries-demo')}
                        className={submenuItemClass}
                      >
                        <Book className="h-3.5 w-3.5 mr-2 opacity-70" />
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/responsive-demo'}
                        onClick={() => handleNavigation('/responsive-demo')}
                        className={submenuItemClass}
                      >
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/scroll-demo'}
                        onClick={() => handleNavigation('/scroll-demo')}
                        className={submenuItemClass}
                      >
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/scroll-test'}
                        onClick={() => handleNavigation('/scroll-test')}
                        className={submenuItemClass}
                      >
                        <ScrollText className="h-3.5 w-3.5 mr-2 opacity-70" />
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/refresh-demo'}
                        onClick={() => handleNavigation('/refresh-demo')}
                        className={submenuItemClass}
                      >
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/zustand-demo'}
                        onClick={() => handleNavigation('/zustand-demo')}
                        className={submenuItemClass}
                      >
                        <Database className="h-3.5 w-3.5 mr-2 opacity-70" />
                        <span>Zustand Demo</span>
                      </SidebarMenuSubButton>
                    </SidebarMenuSubItem>
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        ...
                        className={submenuItemClass}
                      >
                        <GamepadIcon className="h-3.5 w-3.5 mr-2 opacity-70" />
                        <span>Game Test</span>
                      </SidebarMenuSubButton>
                    </SidebarMenuSubItem>
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton
                        isActive={location === '/csrf-test'}
                        onClick={() => handleNavigation('/csrf-test')}
                        className={submenuItemClass}
                      >
