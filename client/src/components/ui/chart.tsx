    ...
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent
          ...
          align="center"
          className={cn(
            "min-w-[60px] rounded-md border bg-background text-foreground shadow-md",
            className
          )}
        />
      </Tooltip>
...
interface ChartTooltipContentProps extends React.HTMLAttributes<HTMLDivElement> {
  hideLabel?: boolean
  nameKey?: string
  payloadFormatter?: (value: number, name: string) => string
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn("flex flex-col gap-0.5 px-2 py-1", className)}
      {...props}
    />
  )
}
