...
ALTER TABLE IF EXISTS ONLY public.writer_streaks DROP CONSTRAINT IF EXISTS writer_streaks_user_id_users_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.reading_streaks DROP CONSTRAINT IF EXISTS reading_streaks_user_id_users_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.featured_authors DROP CONSTRAINT IF EXISTS featured_authors_user_id_users_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.writer_streaks DROP CONSTRAINT IF EXISTS writer_streaks_pkey;
...
ALTER TABLE IF EXISTS ONLY public.featured_authors DROP CONSTRAINT IF EXISTS featured_authors_pkey;
ALTER TABLE IF EXISTS ONLY public.featured_authors DROP CONSTRAINT IF EXISTS featured_authors_month_year_unique;
...
ALTER TABLE IF EXISTS public.writer_streaks ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.featured_authors ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.writer_streaks_id_seq;
DROP TABLE IF EXISTS public.writer_streaks;
...
DROP SEQUENCE IF EXISTS public.featured_authors_id_seq;
DROP TABLE IF EXISTS public.featured_authors;
...
--
-- Name: featured_authors; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.featured_authors OWNER TO neondb_owner;

--
-- Name: featured_authors_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.featured_authors_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.featured_authors_id_seq OWNER TO neondb_owner;

--
-- Name: featured_authors_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.featured_authors_id_seq OWNED BY public.featured_authors.id;
...
--
-- Name: reading_streaks; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.reading_streaks OWNER TO neondb_owner;

--
-- Name: reading_streaks_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.reading_streaks_id_seq OWNER TO neondb_owner;

--
-- Name: reading_streaks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: writer_streaks; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.writer_streaks (
    id integer NOT NULL,
    user_id integer NOT NULL,
    current_streak integer DEFAULT 0 NOT NULL,
    longest_streak integer DEFAULT 0 NOT NULL,
    last_write_at timestamp without time zone DEFAULT now() NOT NULL,
    total_posts integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.writer_streaks OWNER TO neondb_owner;

--
-- Name: writer_streaks_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.writer_streaks_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.writer_streaks_id_seq OWNER TO neondb_owner;

--
-- Name: writer_streaks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.writer_streaks_id_seq OWNED BY public.writer_streaks.id;
...
--
-- Name: featured_authors id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.featured_authors ALTER COLUMN id SET DEFAULT nextval('public.featured_authors_id_seq'::regclass);
...
--
-- Name: reading_streaks id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: writer_streaks id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.writer_streaks ALTER COLUMN id SET DEFAULT nextval('public.writer_streaks_id_seq'::regclass);
...
1	9785e7c2b1635c1df38a447b091a8562a90dbf61991673fdea6f4a3f07c8286d	1740873449257
\.
...
--
-- Data for Name: featured_authors; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.featured_authors (id, user_id, month_year, description, achievements, stats, created_at) FROM stdin;
\.
...
--
-- Data for Name: reading_streaks; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.reading_streaks (id, user_id, current_streak, longest_streak, last_read_at, total_reads) FROM stdin;
\.
...
1	admin	vantalison@gmail.com	$2a$12$ysgJ95erV.SVxeGEqT/uX.Je988WJcs5rJmtl9oODJASDmsV0qtwq	t	2025-03-03 12:51:56.106678
\.
...
--
-- Data for Name: writer_streaks; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.writer_streaks (id, user_id, current_streak, longest_streak, last_write_at, total_posts) FROM stdin;
\.
...
--
-- Name: featured_authors_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.featured_authors_id_seq', 1, false);
...
--
-- Name: reading_streaks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.reading_streaks_id_seq', 1, false);
...
--
-- Name: writer_streaks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.writer_streaks_id_seq', 1, false);
...
--
-- Name: featured_authors featured_authors_month_year_unique; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.featured_authors
    ADD CONSTRAINT featured_authors_month_year_unique UNIQUE (month_year);


--
-- Name: featured_authors featured_authors_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.featured_authors
    ADD CONSTRAINT featured_authors_pkey PRIMARY KEY (id);
...
--
-- Name: reading_streaks reading_streaks_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: writer_streaks writer_streaks_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.writer_streaks
    ADD CONSTRAINT writer_streaks_pkey PRIMARY KEY (id);
...
--
-- Name: featured_authors featured_authors_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.featured_authors
    ADD CONSTRAINT featured_authors_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: reading_streaks reading_streaks_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.reading_streaks
    ADD CONSTRAINT reading_streaks_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: writer_streaks writer_streaks_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.writer_streaks
    ADD CONSTRAINT writer_streaks_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id);
